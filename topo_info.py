...
import math
import os
sys.path.append("C:/Users/admin/Desktop/model_download_file/flac.py") #fdirect path of flac, path depends which PC your on
import flac
fl=flac.Flac()
import numpy as np
...
def topo_local(x,z):
    ...
    for i in range(lths, lthe+1):
        ...
        plt.ylim(-10, 10) #limit range of relief to -10km ~ 10km
        ...
        plt.savefig(f'C:/Users/admin/Desktop/model_download_file/GRm11_r01/figure/local_relief/local_relief_time_step_{i}', dpi = 300) #save in the target folder 
...
"draw topo"
#delete #, for the topo that want to be runned
